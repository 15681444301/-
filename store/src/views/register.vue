  ...
  <div class="login_container">
    ...
    <div class="login-mid">
      ...
      <div class="login-code">
        ...
        <div class="login-code-wx">添加微信寻求帮助</div>
      </div>
      <!-- 账号密码登录 -->
      <div class="logon-passwod">
        ...
        >
          ...
          <el-form-item class="btns">
            ...
            <el-button type="warning" @click="gologin">立马登录</el-button>
          </el-form-item>
        </el-form>
      </div>
    </div>
...
export default {
  ...
  data() {
    return {
      ...
      loginrules: {
        name: [
          { required: true, message: "用户名不能少于5位", trigger: "blur" },
          { min: 5, max: 20, message: "长度在 6 到 10个字符", trigger: "blur" },
        ],
        //验证密码是否合法
        password: [
  ...
  methods: {
    ...
    register() {
      this.$refs.loginref.validate((valid) => {
        if (!valid) return;
        this.$axios
          .post("http://localhost:5000/api/v1/register", this.loginfrom)
          .then((res) => {
            console.log(res);
            if (res.data.code == 1) {
              this.$message({
